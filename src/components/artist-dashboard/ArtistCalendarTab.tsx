...
const ArtistCalendarTab = () => {
  ...
  const blockDates = () => {
    if (selectedDates.length > 0) {
      ...
      toast({
        ...
        description: t(
          "Your unavailable dates have been updated",
          "تم تحديث تواريخ عدم التوفر الخاصة بك"
        ),
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="font-gotham-bold">{t("Manage Availability", "إدارة التوفر")}</CardTitle>
