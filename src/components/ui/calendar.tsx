  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-white rounded-md w-9 font-normal text-[0.8rem] text-center",
        ...
        day_selected:
          "bg-orange-500 text-white hover:bg-orange-600 hover:text-white focus:bg-orange-500 focus:text-white shadow-none",
